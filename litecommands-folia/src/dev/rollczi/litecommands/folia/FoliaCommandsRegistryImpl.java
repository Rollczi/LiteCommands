...
class FoliaCommandsRegistryImpl implements FoliaCommandsRegistry {

    private final Lazy<CommandMap> commandMap;
    private final Lazy<Map<String, Command>> knownCommands;

    private FoliaCommandsRegistryImpl(Lazy<CommandMap> commandMap, Lazy<Map<String, Command>> knownCommands) {
        this.commandMap = commandMap;
        this.knownCommands = knownCommands;
    }

    @SuppressWarnings("unchecked")
    static FoliaCommandsRegistry create(Server server) {
        ...
        return new FoliaCommandsRegistryImpl(commandMap, knownCommands);
    }
