...
public class FoliaCommand extends Command {

    private static final Logger LOGGER = Logger.getLogger(FoliaCommand.class.getName());

    private final LiteFoliaSettings settings;
    ...
    FoliaCommand(LiteFoliaSettings settings, CommandRoute<CommandSender> commandRoute, PlatformInvocationListener<CommandSender> invocationHook, PlatformSuggestionListener<CommandSender> suggestionHook, PermissionService permissionService) {
    ...
    public boolean execute(@NotNull CommandSender sender, @NotNull String alias, String[] args) {
        ...
        PlatformSender platformSender = new FoliaPlatformSender(sender);
    ...
    public boolean testPermissionSilent(@NotNull CommandSender target) {
        ...
        return permissionService.isPermitted(new FoliaPlatformSender(target), commandRoute);
    }
