    ...
    public static <SENDER, C extends PlatformSettings, B extends LiteCommandsBaseBuilder<SENDER, C, B>> LiteCommandsBuilder<SENDER, C, B> builder(Class<SENDER> senderClass, Platform<SENDER, C> platform) {
        return new LiteCommandsBaseBuilder<SENDER, C, B>(senderClass, platform).selfProcessor((builder, internal) -> {
            ...
            builder
                ...
                .argument(long.class, NumberArgumentResolver.ofLong())
                .argumentParser(Integer.class, NumberArgumentResolver.ofInteger())
                .argumentParser(int.class, NumberArgumentResolver.ofInteger())
                .argumentParser(Double.class, NumberArgumentResolver.ofDouble())
                .argumentParser(double.class, NumberArgumentResolver.ofDouble())
                .argumentParser(Float.class, NumberArgumentResolver.ofFloat())
                .argumentParser(float.class, NumberArgumentResolver.ofFloat())
                .argumentParser(Byte.class, NumberArgumentResolver.ofByte())
                .argumentParser(byte.class, NumberArgumentResolver.ofByte())
                .argumentParser(Short.class, NumberArgumentResolver.ofShort())
                .argumentParser(short.class, NumberArgumentResolver.ofShort())
