...
dependencies {
    ...
    // implementation("dev.rollczi:litecommands-bukkit:3.0.0-BETA-pre18") // <-- uncomment in your project
    // implementation("dev.rollczi:litecommands-adventure-platform:3.0.0-BETA-pre18") // <-- uncomment in your project
