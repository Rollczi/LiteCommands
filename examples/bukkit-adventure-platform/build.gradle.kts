...
dependencies {
    ...
    // implementation("dev.rollczi:litecommands-bukkit:3.2.1") // <-- uncomment in your project
    // implementation("dev.rollczi:litecommands-adventure-platform:3.2.1") // <-- uncomment in your project
