...
dependencies {
    ...
    // implementation("dev.rollczi:litecommands-bukkit:3.9.2") // <-- uncomment in your project
    // implementation("dev.rollczi:litecommands-adventure-platform:3.9.2") // <-- uncomment in your project
