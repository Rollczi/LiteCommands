...
dependencies {
    ...
    // implementation("dev.rollczi:litecommands-bukkit:3.10.7") // <-- uncomment in your project
    // implementation("dev.rollczi:litecommands-adventure-platform:3.10.7") // <-- uncomment in your project
