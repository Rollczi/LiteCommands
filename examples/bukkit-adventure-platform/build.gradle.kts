...
dependencies {
    ...
    // implementation("dev.rollczi:litecommands-bukkit:3.9.3") // <-- uncomment in your project
    // implementation("dev.rollczi:litecommands-adventure-platform:3.9.3") // <-- uncomment in your project
