...
dependencies {
    ...
    // implementation("dev.rollczi:litecommands-bukkit:3.3.0") // <-- uncomment in your project
    // implementation("dev.rollczi:litecommands-adventure-platform:3.3.0") // <-- uncomment in your project
