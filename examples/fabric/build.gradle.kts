...
dependencies {
    ...
    // modImplementation("dev.rollczi:litecommands-fabric:3.10.8") <-- uncomment in your project
    // modImplementation("dev.rollczi:litecommands-luckperms:3.10.8") <-- uncomment in your project
