...
public class ValueWrappedExpectedContextualFactory implements WrappedExpectedContextualFactory {
    ...
    @Override
    public <EXPECTED> WrappedExpectedContextual<EXPECTED> wrap(ExpectedContextualProvider<EXPECTED> expectedContextualProvider, dev.rollczi.litecommands.modern.command.contextual.ExpectedContextual<EXPECTED> context) {
    ...
    @Override
    public <EXPECTED> Option<WrappedExpectedContextual<EXPECTED>> empty(dev.rollczi.litecommands.modern.command.contextual.ExpectedContextual<EXPECTED> context) {
        return Option.none();
    }
