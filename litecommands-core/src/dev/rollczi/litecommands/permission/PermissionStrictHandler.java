...
public interface PermissionStrictHandler {
    void check(PlatformSender platformSender, Set<Set<String>> permissions, List<String> collected, List<String> missingPermissions);

    PermissionStrictHandler DEFAULT = (platformSender, permissions, collected, missingPermissions) -> {
    ...
    PermissionStrictHandler OR = (platformSender, permissions, collected, missingPermissions) -> {
        for (Set<String> permissionSet : permissions) {
            collected.addAll(permissionSet);
        }
