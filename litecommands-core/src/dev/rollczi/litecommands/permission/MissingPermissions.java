...
public class MissingPermissions {
    ...
    public static MissingPermissions check(PermissionStrictHandler strictHandler, PlatformSender platformSender, MetaHolder metaHolder) {
        ...
        while (current != null) {
            ...
            strictHandler.check(platformSender, permissions, collected, missingPermissions);
