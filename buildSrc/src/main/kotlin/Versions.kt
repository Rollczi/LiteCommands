object Versions {
    ...
    const val FABRIC_YARN_MAPPINGS = "1.21.9-pre2+build.2"
    val FABRIC_MINECRAFT = FABRIC_YARN_MAPPINGS.substringBefore('+')
    const val FABRIC_LOADER = "0.17.2"
    const val FABRIC_COMMAND_API_V2 = "2.3.5+33df5e6e94"
    const val FABRIC_COMMAND_API_V1 = "1.2.56+f71b366f73"
    const val FABRIC_LIFECYCLE_EVENTS_V1 = "2.6.8+33df5e6e94"
