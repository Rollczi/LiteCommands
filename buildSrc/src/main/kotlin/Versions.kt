object Versions {
    ...
    const val FABRIC_YARN_MAPPINGS = "1.21.10+build.2"
    val FABRIC_MINECRAFT = FABRIC_YARN_MAPPINGS.substringBefore('+')
    const val FABRIC_LOOM_PLUGIN = "1.11.8"
    const val FABRIC_LOADER = "0.17.3"
    const val FABRIC_COMMAND_API_V2 = "2.4.1+65ffd040c8"
    const val FABRIC_COMMAND_API_V1 = "1.2.56+f71b366f73"
    const val FABRIC_LIFECYCLE_EVENTS_V1 = "2.6.10+65ffd040c8"
