...
- [Example (Modern 2.0.5)](https://github.com/Rollczi/LiteCommands/tree/master/examples/bukkit)
...
```
```groovy
implementation 'dev.rollczi.litecommands:core:2.0.5'
```
...
```
```groovy
implementation 'dev.rollczi.litecommands:velocity:2.0.5'
```
